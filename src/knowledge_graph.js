...
module.exports = class KnowledgeGraph {
    ...
    _createEdge(record) {
        return {
            predicate:
                'biolink:' +
                (typeof record.$edge_metadata.trapi_qEdge_obj.getQueryPredicate() === 'undefined'
                    ? record.$edge_metadata.predicate
                    : record.$edge_metadata.trapi_qEdge_obj.getQueryPredicate()),
